    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-24 md:bottom-8 right-6 md:right-8 z-[90] size-12 md:size-14 rounded-2xl bg-primary text-primary-text shadow-2xl shadow-primary/20 flex items-center justify-center border border-theme backdrop-blur-md hover:bg-primary-hover transition-colors group"
