  ...
  return (
    <footer className="w-full bg-[var(--surface)] border-t border-[var(--border)] pt-12 pb-8 px-6 md:hidden relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="mb-12 p-6 rounded-3xl bg-card-bg border border-theme backdrop-blur-md">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full h-12 pl-12 pr-4 bg-card-bg border border-theme rounded-xl text-sm focus:outline-none focus:border-primary transition-all text-[var(--text)]"
                required
              />
            </div>
            <button 
              ...
              className={`h-12 rounded-xl font-bold text-xs uppercase tracking-widest transition-all active:scale-95 flex items-center justify-center gap-2 ${
                status === 'success' ? 'bg-success text-primary-text' : 'bg-primary text-primary-text shadow-lg shadow-primary/20'
              }`}
            >
              {status === 'loading' ? (
        ...
        <div className="flex items-center justify-center gap-3.5 mb-10">
          {[
            { Icon: LinkedinIcon, color: "active:bg-[#0077B5] active:text-primary-text" },
            { Icon: XIcon, color: "active:bg-primary-bg active:text-primary-text" },
            { Icon: InstagramIcon, color: "active:bg-[#E4405F] active:text-primary-text" },
            { Icon: YoutubeIcon, color: "active:bg-[#FF0000] active:text-primary-text" }
          ].map((item, i) => (
            <a 
              key={i} 
              href="#" 
              className={`p-2.5 rounded-xl bg-card-bg border border-theme text-[var(--text-secondary)] transition-all active:scale-90 shadow-sm ${item.color}`}
            >
