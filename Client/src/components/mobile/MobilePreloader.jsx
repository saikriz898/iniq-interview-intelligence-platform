  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col items-center gap-5">
          <div className="flex items-center gap-3">
            ...
            <motion.p
              ...
              className="text-[10px] font-black uppercase tracking-[0.4em] text-primary-text/60"
            >
              Loading Mastery
            </motion.p>
          </div>
      ...
      <div className="absolute bottom-10 flex flex-col items-center gap-3">
        <div className="flex items-center gap-2 px-3 py-1.5 bg-card-bg rounded-full border border-theme backdrop-blur-sm">
          <Shield className="size-3 text-primary" />
          <span className="text-[8px] font-bold text-primary-text/40 tracking-widest uppercase">Secured Platform</span>
        </div>
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.2 }}
          className="text-[7px] font-mono tracking-[0.3em] text-primary-text/50"
        >
