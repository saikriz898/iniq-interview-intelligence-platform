    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-16">
        ...
        <div className="relative group">
          ...
          <motion.div
            ...
            className="absolute -inset-12 border border-theme rounded-full border-t-primary/40 border-b-primary/40 blur-sm"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 6, repeat: Infinity, ease: "linear" }}
            className="absolute -inset-16 border border-theme rounded-full border-l-accent/30 border-r-accent/30 blur-[2px]"
          />
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-4">
            <span className="w-12 h-[1px]   to-white/10" />
            <motion.p 
              animate={{ opacity: [0.3, 0.6, 0.3] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="text-[10px] font-black uppercase tracking-[0.6em] text-primary-text/40"
            >
      ...
      <div className="absolute bottom-12 flex flex-col items-center gap-2">
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          className="text-[8px] font-mono tracking-widest text-primary-text/50 uppercase"
        >
