...
const SupportAppShell = ({ children, isLoading }) => {
  ...
  const SupportNavbar = (
    <nav className="w-full h-16 fixed top-0 left-0 right-0 z-[100] bg-card-bg dark:bg-slate-900/90 backdrop-blur-xl border-b border-border flex items-center justify-between px-4 md:px-12">
      ...
      <div className="flex items-center gap-2 md:gap-5">
        ...
        <Link 
          to="/register" 
          className="px-4 md:px-7 py-2 md:py-3 bg-primary text-primary-text text-[9px] md:text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all text-center"
        >
