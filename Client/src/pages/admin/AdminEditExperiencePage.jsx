                ...
                <div className="h-24 sm:h-28 border-b border-border/40 px-8 lg:px-12 flex items-center justify-between shrink-0 bg-background/5 backdrop-blur-md relative z-[60]">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-surface border border-border/60 text-[8px] font-black text-text-muted uppercase tracking-widest  italic">Mode: Administrative Override</div>
                            </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button 
                            ...
                            className="px-8 py-4 rounded-xl bg-primary text-primary-text text-[11px] font-black uppercase tracking-widest shadow-2xl shadow-primary/30 hover:translate-x-1 transition-all active:scale-95"
                        >
                            Commit Changes
                        </button>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                            ...
                            <div className="lg:col-span-1 flex flex-col gap-8">
                                ...
                                <div className="flex flex-col gap-6">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Target Company Node</label>
                                        <input 
                                            type="text" 
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Assigned Role Hierarchy</label>
                                        <input 
                                            type="text" 
                                            value={formData.role}
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Candidate Experience</label>
                                        <input 
                                            type="text" 
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Process Verdict</label>
                                        <select 
                            ...
                            <div className="lg:col-span-2 flex flex-col gap-12">
                                <div className="flex flex-col gap-8">
                                    ...
                                    <div className="flex flex-col gap-6">
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Operational Overview</label>
                                            <textarea 
                                                rows="4"
                                        ...
                                        <div className="flex flex-col gap-6">
                                            <div className="flex items-center justify-between">
                                                <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Intelligence Rounds Hierarchy</label>
                                                <button 
                                                ...
                                                {formData.rounds.map((round, i) => (
                                                    ...
                                                    >
                                                        <button 
                                                            ...
                                                            className="absolute top-6 right-6 size-8 rounded-full bg-danger/10 text-danger opacity-0 group-hover:opacity-100 flex items-center justify-center hover:bg-danger hover:text-primary-text transition-all shadow-sm"
                                                        >
                                                            <X className="size-4" />
                                                        </button>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] px-1 ">Legacy Intelligence (Advice)</label>
                                            <textarea 
                                                rows="3"
                                                value={formData.advice}
                                                onChange={(e) => setFormData({...formData, advice: e.target.value})}
                                                className="w-full p-6 rounded-[2rem] bg-success/5 border border-success/20 focus:border-success text-sm font-bold text-success leading-relaxed outline-none italic transition-all uppercase tracking-widest no-scrollbar placeholder:text-success/40"
                                            />
                                        </div>
                                    </div>
                                </div>
