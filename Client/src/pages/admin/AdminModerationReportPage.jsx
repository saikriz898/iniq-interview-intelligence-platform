                ...
                <div className="max-w-4xl mx-auto w-full flex flex-col gap-10 pt-4 pb-20">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col gap-1">
                                <div className="flex items-center gap-3">
                                    <span className="px-2.5 py-0.5 rounded bg-accent/10 border border-accent/20 text-[9px] font-bold uppercase tracking-wider text-accent italic">Moderation Report Protocol</span>
                                    <span className="text-[10px] font-bold text-text-muted  uppercase tracking-[0.2em]">Archival Ref: RE-SYNC-{id}</span>
                                </div>
                    ...
                    >
                        <div className={`size-20 rounded-[2rem] flex items-center justify-center p-5 shadow-inner ${
                            decisionLog.status === 'Approved' ? 'bg-success text-primary-text' : 'bg-danger text-primary-text'
                        }`}>
                            {decisionLog.status === 'Approved' ? <CheckCircle2 className="size-10" /> : <XCircle className="size-10" />}
                        </div>
                        <div className="flex flex-col gap-1.5 flex-1">
                            <span className={`text-[11px] font-black uppercase tracking-[0.3em] ${
                                decisionLog.status === 'Approved' ? 'text-success' : 'text-danger'
                            }`}>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="p-8 lg:p-10 rounded-3xl bg-surface border border-border shadow-sm flex flex-col gap-6 group hover:border-primary/20 transition-all">
                            <div className="flex flex-col gap-3">
                                <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest  italic">Selection / Rejection Reason</span>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest ">Moderator ID</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="p-6 rounded-2xl bg-surface border border-border flex flex-col gap-4 shadow-sm">
                                <div className="flex flex-col gap-1">
                                    <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest ">Company Node</span>
                                    <span className="text-base font-black text-content uppercase tracking-tight italic">{submission.company}</span>
                                </div>
                                <div className="flex flex-col gap-1">
                                    <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest ">Position Role</span>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="p-6 rounded-2xl bg-surface border border-border flex flex-col gap-4 shadow-sm">
                                <div className="flex flex-col gap-1">
                                    <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest ">Platform Contributor</span>
                                    <span className="text-base font-black text-content italic lowercase tracking-tight">@{submission.user}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest ">Technical Modules</span>
                                    ...
                                    <Activity className="size-6 text-success opacity-40" />
                                </div>
                            </div>
                        </div>
                    </div>
