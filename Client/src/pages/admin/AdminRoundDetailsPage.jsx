                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex flex-col gap-0.5">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-bold text-text-muted  uppercase tracking-widest leading-none">Parent ID: {id}</span>
                            </div>
                    ...
                    <div className="max-w-5xl mx-auto w-full flex flex-col gap-12">
                                    ...
                                    <div key={i} className="flex flex-col gap-6 p-10 rounded-[2.5rem] bg-surface border border-border shadow-sm hover:border-primary/20 transition-all">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className={`px-3.5 py-1.5 rounded-full border text-[9px] font-bold uppercase tracking-widest ${
                                                    p.difficulty === 'Hard' ? 'bg-danger/10 border-danger/20 text-danger' : 
                                                    p.difficulty === 'Medium' ? 'bg-warning/10 border-warning/20 text-warning' : 'bg-success/10 border-success/20 text-success'
                                                }`}>
                                                    {p.difficulty}
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex flex-col gap-8">
                                            <div className="flex flex-col gap-3">
                                                <span className="text-[10px] font-bold text-text-muted  uppercase tracking-widest flex items-center gap-2 italic">
                                            ...
                                            <div className="flex flex-col gap-4">
                                                ...
                                                {p.code ? (
                                                    <div className="rounded-2xl bg-[#0F172A] p-8 border border-border overflow-hidden relative group">
                                                        <div className="absolute top-0 right-0 p-4 font-mono text-[9px] text-primary-text/10 uppercase font-black pointer-events-none group-hover:text-primary-text/20 transition-all">javascript_protocol</div>
                                                        <pre className="font-mono text-[13px] leading-relaxed text-accent/90 overflow-x-auto custom-scrollbar-horizontal pb-4">
                                                            {p.code.trim()}
                                                        </pre>
                                                    </div>
                                                ) : (
                        ...
                        {round.feedback && (
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="p-8 rounded-2xl bg-success/5 border border-success/20 shadow-sm flex flex-col gap-3">
                                    <span className="text-[10px] font-bold text-success uppercase tracking-widest italic leading-none">Internal Assessment Protocol</span>
                                    <p className="text-sm font-medium text-success leading-relaxed tracking-wide italic">
                                        "{round.feedback}"
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
                            ...
                            <div className="p-8 rounded-2xl bg-surface border border-border shadow-sm flex flex-col gap-4">
                                ...
                                <div className="flex items-center gap-5">
                                     <div className="size-14 rounded-full border-4 border-success/10 border-t-emerald-500 flex items-center justify-center">
                                        <span className="text-[11px] font-black text-success italic">94%</span>
                                     </div>
