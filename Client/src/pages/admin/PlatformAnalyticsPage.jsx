...
const PlatformAnalyticsPage = () => {
    ...
    const telemetryNodes = [
        ...
        { label: 'Experience Registry', value: '4,103', change: '+8%', trend: 'up', icon: Database, color: 'text-success' },
        { label: 'Verdict Acceptance', value: '62%', change: '-2%', trend: 'down', icon: Target, color: 'text-warning' },
        { label: 'Activity Pulse', value: '94 / s', change: '+15%', trend: 'up', icon: Activity, color: 'text-danger' },
    ];

    const sectoralDistribution = [
        { name: 'FAANG Nodes', val: 78, color: 'bg-primary' },
        { name: 'Unicorn Nodes', val: 56, color: 'bg-success' },
        { name: 'Global Ops', val: 42, color: 'bg-warning' },
        { name: 'Strategic Nodes', val: 24, color: 'bg-danger' },
    ];
            ...
            <div className="h-full w-full flex flex-col bg-background overflow-hidden relative font-['Inter']">
                ...
                <header className="h-16 shrink-0 border-b border-border/40 px-6 flex items-center justify-between bg-surface/5 backdrop-blur-md relative z-30">
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex flex-col gap-0.5">
                            <div className="flex items-center gap-2">
                                <span className="px-2 py-0.5 rounded bg-warning/10 border border-warning/20 text-[8px] font-black uppercase tracking-wider text-warning italic leading-none">Global Intelligence</span>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="px-5 py-2 rounded-xl bg-primary text-primary-text text-[9px] font-black uppercase tracking-widest hover:bg-primary/90 transition-all active:scale-95 shadow-2xl shadow-primary/20 italic flex items-center gap-2">
                            ...
                            {telemetryNodes.map((node, i) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-end justify-between relative z-10">
                                        ...
                                        <div className={`flex items-center gap-1 text-[8px] font-black ${node.trend === 'up' ? 'text-success' : 'text-danger'}`}>
                                            {node.change}
                                        </div>
                                    </div>
                                    <div className="absolute inset-0  from-primary/0 to-primary/[0.02] opacity-0 group-hover/node:opacity-100 transition-opacity" />
                                </motion.div>
                            ))}
                        </div>
                             ...
                             <div className="max-w-4xl w-full px-12 grid grid-cols-2 gap-12 relative z-10">
                                             ...
                                             {sectoralDistribution.map((sector, i) => (
                                                 <div key={i} className="flex flex-col gap-2 group/bar">
                                                     ...
                                                     <div className="h-1.5 w-full bg-surface border border-border rounded-full overflow-hidden shadow-inner p-[1px]">
                                                         ...
                                                         >
                                                             <div className="absolute inset-x-0 h-full bg-card-bg animate-marquee" />
                                                         </motion.div>
                                                     </div>
                                                 </div>
                                             ))}
                                 ...
                                 <div className="flex flex-col items-center justify-center text-center p-12 rounded-full border-2 border-dashed border-border/40 relative group/radar">
                                      ...
                                      <div className="flex flex-col gap-3 mt-8 relative z-10">
                                          ...
                                          <span className="text-[9px] font-black text-text-muted  uppercase tracking-[0.3em] font-['JetBrains_Mono']">GLOBAL_INDEX_EFFICIENCY</span>
                                      </div>
                                      
                                      <div className="absolute -top-4 -right-4 px-4 py-2 rounded-xl bg-success text-primary-text text-[8px] font-black uppercase tracking-widest italic shadow-2xl group-hover:-translate-y-2 transition-transform">
                                          Optimized
                                      </div>
                                 </div>
                             </div>
                            ...
                            {[1, 2, 3, 4, 5, 6, 7, 8].map((_, i) => (
                                ...
                                >
                                    <div className="flex items-center justify-between relative z-10">
                                        ...
                                        <span className="text-[8px] font-black text-text-muted  uppercase tracking-widest font-['JetBrains_Mono']">2M_AGO</span>
                                    </div>
                                    <div className="flex items-center justify-between relative z-10">
