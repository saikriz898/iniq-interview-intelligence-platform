  ...
  const HeroSection = (
    <div className="w-full pt-12 md:pt-16 pb-12 flex flex-col items-center text-center px-5">
      ...
      <motion.p
        ...
        className="text-sm md:text-base text-text-muted font-medium max-w-2xl "
      >
      ...
      {submitted ? (
        ...
        >
          ...
          <button 
            ...
            className="px-10 py-4 bg-primary text-primary-text font-black text-[10px] uppercase tracking-widest rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-lg shadow-primary/20"
          >
            Send Another
          </button>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 relative z-10 flex-grow">
          ...
          <div className="flex items-center justify-between mt-auto pt-6">
            ...
            <button 
              ...
              className={`px-12 py-5 bg-primary text-primary-text font-black text-[12px] uppercase tracking-widest rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/20 flex items-center gap-3 ${isSubmitting ? 'opacity-70 animate-pulse' : ''}`}
            >
