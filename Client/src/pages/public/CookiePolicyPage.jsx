  ...
  const HeroSection = (
    <div className="w-full pt-12 md:pt-16 pb-10 md:pb-12 flex flex-col items-center text-center px-5 text-content">
      ...
      <motion.p
        ...
        className="text-sm md:text-base text-text-muted font-medium max-w-2xl  leading-relaxed"
      >
    ...
    <div className="w-full max-w-[900px] mx-auto px-5 mb-10 md:mb-12">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[12px] md:text-[13px] font-medium text-text-muted leading-relaxed ">
  ...
  const SettingsCTA = (
    <div className="w-full max-w-[900px] mx-auto px-5 mb-20 md:mb-24">
      ...
      >
        ...
        <button 
          className="relative z-10 px-10 py-4 bg-primary text-primary-text font-black text-[10px] md:text-[11px] uppercase tracking-widest rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 w-full md:w-auto"
        >
