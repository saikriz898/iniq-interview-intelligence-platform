...
const HowItWorksPage = () => {
  ...
  const HeroSection = (
    <div className="w-full pt-16 pb-12 flex flex-col items-center text-center px-6">
      ...
      <motion.p
        ...
        className="text-base text-text-muted font-medium max-w-2xl "
      >
  ...
  const FlowSection = (
    <div className="w-full max-w-[1200px] mx-auto px-6 mb-20">
      <div className="relative flex flex-wrap md:flex-nowrap justify-between gap-4 md:gap-0">
        {/* Connection Line */}
        <div className="absolute top-[30px] left-[10%] right-[10%] h-[1px]   via-border  hidden md:block" />
        ...
        {[
          ...
          >
            <div className="size-[60px] rounded-2xl bg-surface border border-border flex items-center justify-center shadow-lg group-hover:border-primary/40 transition-colors relative">
               <span className="absolute -top-2 -right-2 size-6 rounded-full bg-primary text-primary-text text-[10px] font-black flex items-center justify-center border-2 border-background">
                {item.step}
               </span>
  ...
  const CTAActions = (
    <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-4 px-6 pb-24">
      <Link 
        to="/experiences" 
        className="w-full sm:w-auto px-10 py-4 rounded-2xl bg-primary text-primary-text font-black text-[11px] uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2"
      >
