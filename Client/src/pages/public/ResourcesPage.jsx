  ...
  const HeroSection = (
    <div className="w-full pt-12 md:pt-16 pb-12 flex flex-col items-start px-5 md:px-0 max-w-[1100px] mx-auto text-left">
      ...
      <motion.p 
        ...
        className="text-sm md:text-base text-text-muted font-medium max-w-xl  leading-relaxed"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          >
            ...
            <p className="text-sm font-medium text-text-muted leading-relaxed  italic mb-10">{item.desc}</p>
      ...
      <div className="w-full p-10 md:p-14 rounded-[3rem] bg-white border-none shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative overflow-hidden group">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0 w-full md:w-auto">
             <Link to="/experiences" className="w-full sm:w-auto px-10 py-5 bg-slate-950 text-primary-text rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 transition-all flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             {[
               ...
               >
                 ...
                 <span className="text-[7px] font-black uppercase tracking-widest text-text-muted  group-hover:opacity-100 transition-opacity">Launch Module</span>
               </Link>
             ))}
          </div>
       </div>
