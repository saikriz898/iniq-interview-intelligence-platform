        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
           {companies.map((company, i) => (
             ...
             >
                ...
                <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest  mb-6">{company.count} Experiences</span>
        ...
        <div className="mt-24 p-10 md:p-14 rounded-[3rem] bg-[#0A0F1E] border border-border/40 relative overflow-hidden group">
           ...
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="flex flex-col gap-3">
                 ...
                 <h2 className="text-2xl md:text-3xl font-black text-primary-text tracking-tighter">Your target company not listed?</h2>
              ...
              <Link to="/contact" className="px-10 py-5 bg-accent text-primary-text rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 transition-all">
                 Request Company
              </Link>
           </div>
        </div>
