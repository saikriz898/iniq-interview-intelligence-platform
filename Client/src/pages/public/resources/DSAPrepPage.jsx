      ...
      <div className="max-w-[1200px] mx-auto w-full px-5 py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div className="flex flex-col gap-4">
             <div className="size-14 rounded-2xl bg-success/10 border border-success/20 flex items-center justify-center">
                <Code2 className="size-7 text-success" />
             </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
           {items.length > 0 ? items.map((item, i) => (
             ...
             >
                ...
                <p className="text-sm font-medium text-text-muted leading-relaxed  mb-10">{item.desc}</p>
             ...
             <div className="col-span-full py-32 flex flex-col items-center text-center gap-6 border border-dashed border-border/80 rounded-[3rem] bg-surface-hover/10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-text-muted font-bold text-[10px] uppercase tracking-widest ">We're categorizing dynamic problems. Stay tuned for the update.</p>
                </div>
             </div>
           )}
        </div>
        ...
        <div className="mt-24 p-10 md:p-14 rounded-[3rem] bg-[#0A1E14] border border-border/40 relative overflow-hidden group">
           ...
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="flex flex-col gap-3">
                 ...
                 <h2 className="text-2xl md:text-3xl font-black text-primary-text tracking-tighter uppercase leading-tight">Master the patterns asked <br /> in technical rounds.</h2>
              ...
              <Link to="/experiences" className="px-10 py-5 bg-success text-primary-text rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 transition-all">
                 Practice All
              </Link>
           </div>
        </div>
