    ...
    <SupportAppShell isLoading={isLoading}>
      <div className="max-w-[1200px] mx-auto w-full px-5 py-12">
        ...
        <div className="flex flex-col gap-4 mb-16">
           <div className="size-14 rounded-2xl bg-warning/10 border border-warning/20 flex items-center justify-center">
              <Layers className="size-7 text-warning" />
           </div>
           <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-content uppercase">Interview Rounds</h1>
           <p className="text-base text-text-muted font-medium max-w-xl ">
           ...
           {rounds.length > 0 ? rounds.map((round, i) => (
             ...
             >
                ...
                <div className="flex flex-col gap-2 flex-1 text-center md:text-left">
                   ...
                   <p className="text-base font-medium text-text-muted italic  leading-relaxed max-w-2xl">{round.desc}</p>
                </div>
             ...
             <div className="w-full py-32 flex flex-col items-center text-center gap-6 border border-dashed border-border/80 rounded-[3rem] bg-surface-hover/10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-text-muted font-bold text-[10px] uppercase tracking-widest ">We're building our round-specific intelligence. Join us soon.</p>
                </div>
             </div>
           )}
        </div>
        ...
        <div className="mt-24 p-10 md:p-14 rounded-[4rem] bg-[#1A1A0A] border border-border/40 relative overflow-hidden group">
           ...
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="flex flex-col gap-3">
                 ...
                 <h2 className="text-2xl md:text-3xl font-black text-primary-text tracking-tighter uppercase leading-tight">Master the sequence <br /> of your target company's flow.</h2>
              ...
              <Link to="/how-it-works" className="px-10 py-5 bg-warning text-primary-text rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 transition-all">
                 Learn the Flow
              </Link>
           </div>
        </div>
