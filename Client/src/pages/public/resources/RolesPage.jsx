        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div className="flex flex-col gap-4">
             <div className="size-14 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center">
                <UserCircle className="size-7 text-accent" />
             </div>
           ...
           {roles.length > 0 ? roles.map((role, i) => (
             ...
             >
                <div className="flex items-center gap-8">
                   ...
                   <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[10px] font-bold text-text-muted uppercase tracking-[0.2em] ">{role.count} Active Experiences</span>
                   </div>
                </div>
             ...
             <div className="col-span-full py-32 flex flex-col items-center text-center gap-6 border border-dashed border-border/80 rounded-[3rem] bg-surface-hover/10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-text-muted font-bold text-[10px] uppercase tracking-widest ">Try searching for a different role or contribute an experience.</p>
                </div>
             </div>
           )}
        </div>
        ...
        <div className="mt-24 p-10 md:p-14 rounded-[3rem] bg-[#1E0A2E] border border-border/40 relative overflow-hidden group">
           ...
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="flex flex-col gap-3">
                 ...
                 <h2 className="text-2xl md:text-3xl font-black text-primary-text tracking-tighter uppercase leading-tight">Prepare according <br /> according to your target job role.</h2>
              ...
              <Link to="/register" className="px-10 py-5 bg-accent text-primary-text rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 transition-all">
                 Join Community
              </Link>
           </div>
        </div>
