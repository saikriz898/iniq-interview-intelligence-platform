    ...
    <SupportAppShell isLoading={isLoading}>
      <div className="max-w-[1200px] mx-auto w-full px-5 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-24">
           {items.length > 0 ? items.map((item, i) => (
             ...
             >
                ...
                <p className="text-sm font-medium text-text-muted leading-relaxed  mb-12 h-12 line-clamp-2 italic">{item.desc}</p>
                <Link to="/resources/topics" className="mt-auto px-10 py-4 bg-slate-900 text-primary-text rounded-2xl text-[10px] font-black uppercase tracking-widest hover:scale-[1.02] transition-all flex items-center justify-center gap-2">
             ...
             <div className="col-span-full py-32 flex flex-col items-center text-center gap-6 border border-dashed border-border/80 rounded-[3rem] bg-surface-hover/10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-text-muted font-bold text-[10px] uppercase tracking-widest ">Architectural modules are in the final review. Please wait.</p>
                </div>
             </div>
           )}
        </div>
        ...
        <div className="mt-24 p-10 md:p-14 rounded-[3rem] bg-[#0E0A1E] border border-border/40 relative overflow-hidden group">
           <div className="absolute top-0 right-0 w-1/3 h-full  bg-accent/10  pointer-events-none" />
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="flex flex-col gap-3 text-center md:text-left">
                 ...
                 <h2 className="text-2xl md:text-3xl font-black text-primary-text tracking-tighter uppercase leading-tight">Master large-scale system <br /> architectural discussions.</h2>
              ...
              <Link to="/how-it-works" className="px-10 py-5 bg-accent text-primary-text rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 transition-all text-center">
