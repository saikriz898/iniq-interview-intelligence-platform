    ...
    <SupportAppShell isLoading={isLoading}>
      <div className="max-w-[1200px] mx-auto w-full px-5 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           {topics.length > 0 ? topics.map((topic, i) => (
             ...
             >
                ...
                <p className="text-sm font-medium text-text-muted leading-relaxed italic  mb-10 h-12 line-clamp-2">{topic.desc}</p>
             ...
             <div className="col-span-full py-32 flex flex-col items-center text-center gap-6 border border-dashed border-border/80 rounded-[3rem] bg-surface-hover/10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-text-muted font-bold text-[10px] uppercase tracking-widest ">We're updating our technical roadmap. Please check back soon.</p>
                </div>
             </div>
           )}
        </div>
        ...
        <div className="mt-24 p-10 md:p-14 rounded-[3rem] bg-[#0A1A1E] border border-border/40 relative overflow-hidden group">
           <div className="absolute top-0 right-0 w-1/2 h-full  from-emerald-500/10  pointer-events-none" />
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="flex flex-col gap-3">
                 ...
                 <h2 className="text-2xl md:text-3xl font-black text-primary-text tracking-tighter uppercase leading-tight">Master the technical areas <br /> that matter most.</h2>
