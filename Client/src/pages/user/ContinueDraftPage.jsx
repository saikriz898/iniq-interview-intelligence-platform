                ...
                <div className="hidden md:flex w-72 border-r border-border/40 border-l-[3px] border-l-primary/10 bg-surface/5 flex-col p-10 shrink-0 relative z-20">
                    ...
                    <div className="flex flex-col gap-1.5 mb-10">
                        ...
                        <div className="flex items-center gap-1.5 ml-0.5">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-[0.15em] text-text-muted ">Revision Active</span>
                        </div>
                    </div>
                        ...
                        {steps.map((step) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col text-left pt-0.5">
                                    ...
                                    <span className="text-[8px] font-bold text-text-muted  leading-none mt-1">{step.desc}</span>
                                </div>
                            </button>
                        ))}
                    </div>
                    ...
                    {/* Canvas Header */}
                    <div className="h-20 border-b border-border/40 px-6 md:px-10 flex items-center justify-between shrink-0 bg-background/5 backdrop-blur-sm relative z-10">
                            ...
                            >
                                <div className="max-w-4xl mx-auto w-full flex flex-col gap-6 h-full">
                                    {currentStep === 1 && (
                                        <div className="space-y-10">
                                            ...
                                            <div className="flex flex-col gap-3">
                                                <label className="text-[10px] font-black uppercase tracking-widest text-text-muted  ml-1">Preparation Narrative</label>
                                                <textarea 
                                    ...
                                    {currentStep === 2 && (
                                        <div className="space-y-10">
                                            <div className="flex flex-col gap-3">
                                                <label className="text-[10px] font-black uppercase tracking-widest text-text-muted  ml-1">Draft Process Synopsis</label>
                                                <textarea 
                                    ...
                                    {currentStep === 3 && (
                                        <div className="h-full flex flex-col min-h-0">
                                            <div className="flex flex-col mb-8 shrink-0">
                                                ...
                                                <p className="text-[9px] font-bold text-text-muted  uppercase tracking-widest mt-1">Modifying technical modules</p>
                                            </div>
                                                ...
                                                {rounds.map((round, idx) => (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between mb-8">
                                                            ...
                                                            <button onClick={() => removeRound(round.id)} className="p-2 rounded-lg text-text-muted hover:text-danger hover:bg-danger/10 transition-colors opacity-0 group-hover:opacity-100">
                                                        ...
                                                        <div className="grid grid-cols-1 gap-8">
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                                <div className="flex flex-col gap-3">
                                                                    <label className="text-[10px] font-black uppercase tracking-widest text-text-muted  ml-1">Interrogations</label>
                                                                ...
                                                                <div className="flex flex-col gap-3">
                                                                    <label className="text-[10px] font-black uppercase tracking-widest text-text-muted  ml-1">Resolution Strategy</label>
                                    ...
                                    {currentStep === 4 && (
                                        <div className="space-y-8">
                                             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div className="flex flex-col gap-3">
                                                    <label className="text-[10px] font-black uppercase tracking-widest text-text-muted  ml-1">Verdict Revision</label>
                                                ...
                                                <div className="flex flex-col gap-3">
                                                    <label className="text-[10px] font-black uppercase tracking-widest text-text-muted  ml-1">Refined Advice</label>
                                                    <textarea 
                    ...
                    {/* Canvas Footer */}
                    <div className="h-20 border-t border-border/40 px-6 md:px-12 flex items-center justify-between shrink-0 bg-background/5 backdrop-blur-sm relative z-10">
                        <button 
                        ...
                        <button 
                            ...
                            className={`flex items-center gap-3 px-10 py-4 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-xl ${
                                currentStep === totalSteps 
                                    ? 'bg-primary text-primary-text shadow-primary/25 hover:-translate-y-0.5 active:scale-95' 
                                    : 'bg-primary text-primary-text shadow-primary/25 hover:-translate-y-0.5 active:scale-95'
                            }`}
                        >
    ...
    return (
        ...
        >
            <motion.div 
                ...
                className="w-full max-w-sm bg-surface border border-theme rounded-[3rem] p-12 shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col items-center"
            >
                    ...
                    <AnimatePresence mode="wait">
                        {phase !== 'deploying' ? (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-3 w-full">
                                    <div className="flex items-center justify-between px-2">
                                        ...
                                        <span className="text-[10px] font-black text-text-muted ">{phase === 'authenticating' ? '45%' : '88%'}</span>
                                    </div>
                                    ...
                                    <p className="text-[9px] font-bold text-text-muted  uppercase tracking-widest text-center mt-2 italic">Securing Journey Nodes</p>
                                </div>
                            </motion.div>
                        ) : (
                            <motion.div 
                            ...
                            >
                                ...
                                <div className="py-2 px-6 rounded-full bg-success/10 border border-success/20 flex items-center gap-2">
                                    <div className="size-1.5 rounded-full bg-success shadow-[0_0_10px_rgba(34,197,94,0.8)] animate-pulse" />
                                    <span className="text-[9px] font-black text-success uppercase tracking-[0.3em]">Encryption Complete</span>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
