      ...
      <div className="h-full flex flex-col overflow-hidden p-6 md:p-10 gap-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 shrink-0">
            ...
            <button 
                ...
                className="px-6 py-3 rounded-xl bg-primary text-primary-text text-[11px] font-black uppercase tracking-widest flex items-center gap-2.5 shadow-xl shadow-primary/20 hover:-translate-y-0.5 active:scale-95 transition-all w-fit"
            >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar relative px-1">
                <table className="w-full text-left border-collapse">
                    <thead className="sticky top-0 z-10 bg-surface/80 backdrop-blur-md border-b border-border/40">
                        <tr>
                            <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted ">Journey Module</th>
                            <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted ">Last Edited</th>
                            <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted  text-center">Protocol Maturity</th>
                            <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted  text-right">Action Hub</th>
                        </tr>
                    </thead>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest ">{draft.role}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex flex-col gap-2 max-w-[120px] mx-auto">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-[8px] font-black uppercase tracking-widest text-text-muted ">Progression</span>
                                            ...
                                            <div className="flex items-center justify-end gap-2 relative">
                                                <button 
                                                    ...
                                                    className={`p-2.5 rounded-xl border transition-all ${
                                                        openMenuId === draft.id 
                                                        ? 'bg-primary border-primary text-primary-text shadow-lg'
                                                        ...
                                                        <>
                                                            ...
                                                            >
                                                                ...
                                                                <button 
                                                                    ...
                                                                    className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-text-muted hover:text-danger hover:bg-danger/5 transition-all text-left"
                                                                >
                                ...
                                <tr>
                                    <td colSpan="4" className="px-8 py-20">
                                         <div className="flex flex-col items-center justify-center gap-8 text-center bg-surface/40 p-12 lg:p-20">
                                            ...
                                            <button 
                                                onClick={() => navigate('/submit')}
                                                className="group px-8 py-4 rounded-2xl bg-primary text-primary-text text-xs font-black uppercase tracking-[0.2em] shadow-xl shadow-primary/20 hover:-translate-y-0.5 transition-all flex items-center gap-3"
                                            >
