...
const LogDetailsPage = () => {
    ...
    const getStatusStyles = (status) => {
        switch(status) {
            case 'Success': return 'text-success bg-success/5';
            case 'Threat': return 'text-danger bg-danger/5';
            case 'Security': return 'text-accent bg-accent/5';
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar p-10 lg:p-12">
                    <div className="max-w-5xl mx-auto flex flex-col gap-10 pb-20">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="p-8 rounded-[2.5rem] bg-surface border border-border/40 flex flex-col gap-8">
                                <div className="flex items-center gap-3">
                                    <div className="size-8 rounded-lg bg-success/5 flex items-center justify-center text-success">
                        ...
                        <div className="p-8 rounded-[2.5rem] bg-surface-hover/20 border border-border/20 border-dashed flex flex-col gap-6">
                             <div className="flex items-center gap-3">
                                <div className="size-8 rounded-lg bg-warning/5 flex items-center justify-center text-warning">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="flex flex-col gap-1.5">
                                    <span className="text-[9px] font-black text-text-muted  uppercase tracking-widest">Calculated Risk Score</span>
                                    <span className="text-sm font-black text-success font-mono tracking-tighter">{log.riskScore}</span>
                                </div>
                                <div className="flex flex-col gap-1.5 md:border-x md:border-border/20 md:px-8">
                                    <span className="text-[9px] font-black text-text-muted  uppercase tracking-widest">Entry Protocol</span>
                                    <span className="text-sm font-black text-content italic">OAuth_Verif_v3</span>
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    <span className="text-[9px] font-black text-text-muted  uppercase tracking-widest">Dossier Impact</span>
