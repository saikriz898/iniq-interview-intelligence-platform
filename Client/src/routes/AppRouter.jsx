...
import ViewRoundsPage from '../pages/user/ViewRoundsPage';
...
import GlobalReviewsPage from '../pages/admin/GlobalReviewsPage';
...
const AppRouter = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/my-submissions/:id/rounds" element={<ProtectedRoute><ViewRoundsPage /></ProtectedRoute>} />
      <Route path="/drafts" element={<ProtectedRoute><DraftsPage /></ProtectedRoute>} />
      <Route path="/drafts/:id" element={<ProtectedRoute><ContinueDraftPage /></ProtectedRoute>} />
      <Route path="/notifications" element={<ProtectedRoute><NotificationsPage /></ProtectedRoute>} />
      <Route path="/profile" element={<ProtectedRoute><ProfilePage /></ProtectedRoute>} />
      <Route path="/profile/view" element={<ProtectedRoute><ViewProfilePage /></ProtectedRoute>} />
      ...
      <Route path="/admin/reviews" element={<AdminRoute><GlobalReviewsPage /></AdminRoute>} />
      <Route path="/admin/reviews/:id" element={<AdminRoute><ReviewSubmissionDetailsPage /></AdminRoute>} />
      <Route path="/admin/reviews/:id/rounds/:roundIndex" element={<AdminRoute><AdminRoundDetailsPage /></AdminRoute>} />
      <Route path="/admin/reviews/:id/report" element={<AdminRoute><AdminModerationReportPage /></AdminRoute>} />
