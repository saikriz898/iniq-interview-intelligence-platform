    ...
    return (
        <nav className="fixed top-0 left-0 w-full h-16 sm:h-20 border-b border-border/40 bg-surface/80 backdrop-blur-md z-[120] px-6 md:px-10 flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
                <Link to="/admin/dashboard" className="flex items-center group gap-4">
                ...
                <div className="hidden lg:flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-surface-hover/50 border border-border focus-within:border-primary/40 focus-within:bg-surface transition-all w-96 group">
                    <Search className="size-4 text-text-secondary opacity-40 group-focus-within:opacity-100 group-focus-within:text-primary transition-all" />
                    <input 
                        type="text" 
            ...
            <div className="flex items-center gap-2 sm:gap-4">
                ...
                <div className="relative">
                    ...
                    >
                        <div className="size-9 rounded-xl bg-gradient-to-br from-primary to-accent p-0.5 shadow-sm overflow-hidden">
