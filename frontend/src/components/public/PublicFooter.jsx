      ...
      <div className="w-full max-w-[1400px] mx-auto flex flex-col relative z-10">
        ...
        <div className="w-full p-10 md:p-14 mb-16 card-base glow-border relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="flex flex-col lg:flex-1 text-center lg:text-left relative z-10">
            ...
            <p className="text-sm md:text-base font-medium text-text-secondary max-w-lg mx-auto lg:mx-0 leading-relaxed opacity-60">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto lg:min-w-[480px] relative z-10">
            <div className="relative w-full group">
              <Mail className="absolute left-5 top-1/2 -translate-y-1/2 size-4 text-text-secondary opacity-40 group-focus-within:text-primary transition-all" />
              <input 
                type="email" 
                value={email}
                ...
                className="w-full h-14 pl-12 pr-6 bg-surface border border-border rounded-2xl text-sm font-medium focus:outline-none focus:border-primary/40 transition-all text-content placeholder:text-text-secondary/30 disabled:opacity-50 shadow-inner"
                required
              />
            </div>
            <button 
              ...
              className={`btn-primary h-14 px-10 text-xs tracking-widest uppercase shadow-xl ${status === 'success' ? 'bg-emerald-500' : ''}`}
            >
              {status === "loading" ? (
        ...
        <div className="w-full pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-[10px] md:text-[11px] font-bold uppercase tracking-[0.4em] text-text-secondary opacity-30 font-['Space_Grotesk']">
