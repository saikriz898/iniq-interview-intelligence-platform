                    ...
                    <>
                        ...
                        >
                            <div className="p-6 border-b border-border/40 flex items-center justify-between bg-surface/50 relative">
                                ...
                                <button className="p-2.5 hover:bg-surface-hover rounded-xl transition-all text-text-secondary hover:text-primary active:scale-90 border border-transparent hover:border-border/40">
                                    ...
                                    <div key={notif.id} className="p-4 hover:bg-surface-hover/50 transition-colors border-b border-border/10 flex items-start gap-3 cursor-pointer group">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="flex items-center justify-between gap-2">
                                                <span className="text-[9px] font-bold tracking-widest text-content group-hover:text-primary transition-colors uppercase font-['Space_Grotesk']">{notif.title}</span>
                                                <span className="text-[8px] font-medium text-text-secondary opacity-40">{notif.time}</span>
                                            </div>
                                            <p className="text-[11px] font-medium text-text-secondary leading-relaxed">{notif.msg}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
