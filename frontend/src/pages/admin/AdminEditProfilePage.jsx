                        ...
                        <div className="flex items-center gap-6 z-10">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <div className="flex items-center gap-3">
                                    <span className="px-2.5 py-0.5 rounded bg-amber-500/10 border border-amber-500/20 text-[9px] font-bold uppercase tracking-wider text-amber-500 italic">Institutional ID Modification</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-10">
                            <div className="flex flex-col items-center gap-8 p-10 rounded-[2.5rem] bg-surface border border-border shadow-xl relative overflow-hidden group">
                                ...
                                <div className="size-52 rounded-[2.5rem] bg-background border border-border flex items-center justify-center shadow-inner relative z-10 group-hover:scale-105 transition-transform overflow-hidden">
                        ...
                        <form onSubmit={handleSave} className="lg:col-span-8 flex flex-col gap-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <input 
                                            ...
                                            disabled={true}
                                            className="w-full p-5 rounded-2xl bg-surface border border-border text-[14px] font-bold lowercase tracking-tight outline-none opacity-50 cursor-not-allowed italic" 
                                        />
                                    </div>
                                     <div className="flex flex-col gap-3 md:col-span-2">
                                        <label className="text-[10px] font-bold text-text-muted uppercase tracking-widest px-1 opacity-60">Profile Picture URL</label>
                                        <div className="relative group">
                                            <div className="absolute left-5 top-1/2 -translate-y-1/2 size-5 flex items-center justify-center">
                                                <Image className="size-full text-primary/30 group-focus-within:text-primary transition-colors" />
                                            </div>
                                            <input 
                                                type="text" 
                                                ...
                                                className="w-full py-5 pl-14 pr-6 rounded-2xl bg-surface border border-border focus:border-primary text-[12px] font-bold text-content outline-none shadow-sm"
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col gap-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="flex flex-col gap-3">
                                        <label className="text-[10px] font-bold text-text-muted uppercase tracking-widest px-1 opacity-60">Global Synchronization Domain</label>
                                        <input 
                                            type="text" 
