                ...
                <div className="max-w-[1200px] mx-auto w-full h-full flex flex-col gap-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 shrink-0 pt-2">
                        ...
                        <div className="flex items-center gap-3">
                             ...
                             <button 
                                onClick={clearAlerts}
                                className="h-[52px] px-6 rounded-xl bg-surface border border-border text-[10px] font-black uppercase tracking-widest text-rose-500 hover:bg-rose-500 hover:text-white transition-all flex items-center gap-3 shadow-sm active:scale-95 group"
                             >
                                ...
                                filteredNotifs.map((notif, i) => (
                                    ...
                                    >
                                        ...
                                        <button 
                                            ...
                                            className="size-10 rounded-lg bg-surface border border-border flex items-center justify-center text-text-muted hover:text-rose-500 transition-all opacity-0 group-hover:opacity-100 active:scale-95"
                                        >
                                            <Trash2 className="size-4.5" />
                                        </button>
                                    </motion.div>
