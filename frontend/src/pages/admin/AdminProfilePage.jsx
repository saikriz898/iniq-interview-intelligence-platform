                    ...
                    <div className="flex flex-col md:flex-row items-center gap-10 border-b border-border pb-12">
                        ...
                        <div className="flex flex-col gap-4 text-center md:text-left">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <h1 className="text-4xl font-black text-content uppercase tracking-tight leading-none font-['Inter']">{profileData.name}</h1>
                                <p className="text-[10px] font-bold text-text-muted opacity-40 uppercase tracking-[0.2em] mt-3">{profileData.domain || 'Platform Operations Specialist'} // Identity Node: {profileData._id.slice(-6).toUpperCase()}</p>
                            </div>
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-4 flex-wrap mt-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <MapPin className="size-4 text-text-muted opacity-40" />
