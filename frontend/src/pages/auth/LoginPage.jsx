          ...
          >
            ...
            <div className="flex flex-col gap-6">
              ...
              <button 
                ...
                className="w-full py-4 px-6 rounded-2xl bg-surface border border-border hover:border-primary/40 hover:bg-surface-hover transition-all flex items-center justify-center gap-3 group shadow-sm active:scale-[0.98]"
              >
