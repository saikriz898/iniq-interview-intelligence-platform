...
const HomePage = () => {
  ...
  const HeroSection = (
    <div className="w-full relative py-12 md:py-20 min-h-[calc(100vh-80px)] flex flex-col items-center justify-center overflow-hidden">
      <div className="max-w-[1600px] w-full mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col items-start gap-8 relative z-20">
          ...
          <motion.p
            ...
            className="text-lg text-text-secondary font-medium max-w-lg leading-relaxed opacity-60"
          >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10 border-t border-border w-full mt-4">
            {[
              ...
              >
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-text-secondary opacity-40">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>

        {/* Right Side: Visual Asset / Hero Image */}
        <div className="lg:col-span-6 relative group hidden lg:flex items-center justify-center scale-[1.0] origin-center lg:translate-x-10">
           <motion.div
           ...
           >
              ...
              {/* Main Visual Image (Treated as a high-end GIF) */}
              <motion.div
                animate={{ y: [-15, 15, -15] }}
                transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
                className="relative rounded-[3rem] overflow-hidden border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.4)] bg-zinc-950"
              >
                  <img 
                    src="/assets/visuals/home_page.png" 
                    alt="Interview Intelligence Visual" 
                    className="w-full h-auto object-cover opacity-95 group-hover:scale-105 transition-transform duration-[3s]"
                  />
                  ...
                  <motion.div 
                    ...
                    className="absolute inset-x-0 h-px bg-gradient-to-r from-transparent via-primary/60 to-transparent shadow-[0_0_20px_rgba(99,102,241,0.6)] z-20"
                  />
              </motion.div>
