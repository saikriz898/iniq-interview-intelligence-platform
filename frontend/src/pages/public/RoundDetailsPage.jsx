    ...
    <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="flex flex-col gap-6">
                ...
                <div className="p-10 rounded-[3.5rem] bg-surface/40 border border-border h-full"><pre className="text-[13px] font-mono text-text-muted leading-relaxed opacity-60 whitespace-pre-wrap">{roundData.solution}</pre></div>
            </div>
            <div className="flex flex-col gap-6">
                <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-primary italic">Technical Rationale</h3>
                <div className="p-10 rounded-[3.5rem] bg-surface-hover/30 border border-border h-full"><p className="text-[14px] font-bold text-text-muted leading-relaxed opacity-60 italic whitespace-pre-wrap">"{roundData.explanation}"</p></div>
            </div>
        </div>
        {roundData.videoLink && (
            <div className="flex flex-col gap-6">
  ...
  const renderHRRound = () => (
    <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-6">
            ...
            <p className="text-xl font-bold text-text-muted opacity-80 italic whitespace-pre-wrap">{roundData.questions}</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-6">
                <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-primary italic">Response Strategy</h3>
                <div className="p-8 rounded-[3rem] bg-surface border-2 border-border h-full"><p className="text-[14px] font-bold text-text-muted opacity-60 leading-relaxed whitespace-pre-wrap">{roundData.explanation}</p></div>
            </div>
            <div className="flex flex-col gap-6">
